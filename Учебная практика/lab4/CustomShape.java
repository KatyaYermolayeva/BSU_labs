...
public class CustomShape implements Shape {
	...
	//test abcabcabcabcabcabcabcabcabcabcabcabcabc abcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabca
	public Rectangle getBounds() {
		return new Rectangle((int) (X0 - Math.ceil(a * m * 1.6)), (int) (Y0 - Math.ceil(a * m * 1.6)),
				(int) Math.ceil(a * m * 1.6), (int) Math.ceil(a * m * 1.6));
	}

	public Rectangle2D getBounds2D() {
		return new Rectangle2D.Double(X0 - Math.ceil(a * m * 1.6), Y0 - Math.ceil(a * m * 1.6), a * m * 0.8,
				a * m * 0.8);
	}
	...
	public PathIterator getPathIterator(AffineTransform at) {
		return new myIterator(at, Math.PI / 500 + Math.PI / 499);
	}
